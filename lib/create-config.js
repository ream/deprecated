...
module.exports = function ({
  ...
  config.resolve.alias
    ...
    .set('@webpack-hot-middleware-client', `webpack-hot-middleware/client?reload=true${port ? `&path=http://${host}:${port}/__webpack_hmr` : ''}`)
  ...
  if (isClient) {
    config
      ...
      .output
        ...
        .publicPath(port ? `http://${host}:${port}/dist/` : homepage)
        .end()
